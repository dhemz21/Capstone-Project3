    ...
    <section class="section register min-vh-100 d-flex flex-column align-items-center justify-content-center py-4">
      ...
      <div class="col-lg-4 d-flex flex-column align-items-center justify-content-center shadow" id="main-container" style="min-height: 450px;">
        ...
        <div class="admin-form">
          ...
          <form class="row g-3 needs-validation" method="post" action=".?folder=action/&page=admin_verify" novalidate>
          <input type="hidden" name="IDnumber">
            ...
            <div class="col-12">
              <button class="btn text-white w-100 rounded-0" id="btn" type="submit" name="submit">Continue</button>
            </div>
            <div class="col-md-12">
            ...
            <div class="col-12 mb-2">
              <p class="text-start"><a href=".?page=admin_forgot" class="text-decoration-none"> Go Back</a> </p>
            </div>
          </form>
        </div>
      </div>
