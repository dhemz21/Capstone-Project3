        ...
        <div class="row justify-content-center">
          ...
          <div class="col-lg-4 d-flex flex-column align-items-center justify-content-center shadow" id="main-container" style="min-height: 450px;">
            <div class="container-title w-100">
              ...
              <form class="row g-3 needs-validation" method="post" action=".?folder=action/&page=admin_update" novalidate>
              <?php
            // Connect to the database
            require_once('database/db_conn.php');
            // Get the user information from the database using the ID number
            $idnumber = $_SESSION['IDnumber'];
            $query = "SELECT IDnumber, firstname, lastname, email FROM tbl_admin WHERE IDnumber='$idnumber'";
            ...
            ?>
              <div class="col-12">
                ...
                <div class="col-12">
                  <button class="btn text-white w-100 rounded-0" id="btn" type="submit" disabled>Submit</button>
                </div>
  ...
  ?>
    <script>
      Swal.fire({
        icon: 'error',
        title: 'error',
        text: "IDnumber not exist, Please try again!"
      })
    </script>
  <?php
    unset($_SESSION['validate']);
