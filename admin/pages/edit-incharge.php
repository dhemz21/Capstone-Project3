    ...
    <div class="container-fluid pb-2">
        ...
        if (isset($_GET['success']) >= 1) {
            echo "<div class='alert alert-success alert-dismissible fade show' role='alert'>
                        Successully updated incharge Information!
            ...
            echo "<div class='alert alert-danger alert-dismissible fade show' role='alert'>
                        Error updating incharge Information!
                        <button type='button' class='close' data-dismiss='alert' aria-label='close'>
                            <span aria-hidden='true'>&times</span>
                        </button>
                </div>";
        ...
        <div class="card shadow-sm rounded-0">
            <div class="card-header text-dark">
                <h3 class="card-title"><i class="fa fa-user-edit"></i><strong> Edit incharge Information</strong></h3>
            </div>
            <!-- /.card-header -->
            <div class="card-body ">
                <?php
                   $userID = $_GET['UserID'];
                 $sql = mysqli_query($conn, "SELECT * FROM tbl_incharge WHERE UserID = '$userID'");
                ...
                <form action=".?folder=action/&page=update-incharge" method="POST">
                    ...
                    <button type="reset" class="btn btn-secondary" onclick="window.location.href='.?page=add-incharge'">Close</button>
                </form>
            </div>
    ...
    ?>
        <script>
            Swal.fire({
                ...
                text: 'You successully updated the incharge info!'
            })
        </script>
    <?php
    ...
    ?>
        <script>
            Swal.fire({
                icon: 'error',
                title: 'error',
                text: 'Error updating incharge info!'
            })
        </script>
    <?php
        unset($_SESSION['validate']);
