...
<div class="row">
    ...
    <div class="container-fluid pb-2">
        ...
        <div class="card shadow-sm rounded-0">
            <div class="card-header text-dark">
                <h3 class="card-title"><i class="fa fa-user-plus"></i><strong> Add Student</strong></h3>
            </div>
            <!-- /.card-header -->
            <div class="card-body ">
                <form action=".?folder=action/&page=save-students" method="POST">
                    <div class="form-row">
                        <div class="form-group col-md-6">
                            ...
                            <input type="text" class="form-control" id="IDnumber" name="IDnumber" placeholder="Enter your student ID" required>
                        </div>
                        <div class="form-group col-md-6">
                        ...
                        <select id="year" class="form-control" id="year" name="year" required>
    ...
    ?>
    <?php
    if (isset($_SESSION['validate']) && $_SESSION['validate'] == 'invalid') {
    ?>
        <script>
            Swal.fire({
                icon: 'error',
                title: 'Invalid file',
                text: ' Only files with a type of student are accepted!'
            })
        </script>
    <?php
        unset($_SESSION['validate']);
