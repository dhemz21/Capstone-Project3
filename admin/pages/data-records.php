...
include("library/call_function2.php");
      ...
      <div class="col-12">
        <div class="card">
          <div class="card-header bg-light">
            <h3 class="card-title"><i class="fa fa-table"></i><strong> Student Records</strong></h3>
          </div>
          <!-- /.card-header -->
          <div class="card-body">
                ...
                ?>
                  ...
                  <td class="text-left py-0 align-middle">
                    <div class="btn-group btn-group-sm">
                      <a href=".?page=edit-student&UserID=<?php echo $getData['UserID']; ?>" class="btn btn-info"><i class="fas fa-edit"></i></a>
                      <a onclick="return confirm('Are you sure you want to delete this student information?')" href=".?folder=action/&page=delete-student&UserID=<?php echo $getData['UserID']; ?>" class="btn btn-danger"><i class="fas fa-trash"></i></a>
                    </div>
                  </td>
                  </tr>
                <?php } ?>
