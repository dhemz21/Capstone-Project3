...
<div class="row">
      <div class="col-12">
        ...
        <a href=".?page=data-records2" class="btn text-white" id="records"><i class="fas fa-table"></i> Records</a>
    ...
    <div class="container-fluid pb-2">
        ...
        <div class="card shadow-sm rounded-0">
            <div class="card-header text-dark">
                <h3 class="card-title"><i class="fa fa-user-plus"></i><strong> Add employee</strong></h3>
            </div>
            <!-- /.card-header -->
            <div class="card-body ">
    ...
    ?>
        <script>
            Swal.fire({
                icon: 'error',
                title: 'Invalid file',
                text: ' Only files with a type of employee are accepted!'
            })
        </script>
    <?php
        unset($_SESSION['validate']);
